...
const ItemDetails = ({ itemDetails: { price, rentFrequency, weight, length, height, area, location, isVerified, description, type, purpose, furnishingStatus, additional, photos } }) => (
